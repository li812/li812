...
A passionate **AI/ML Backend Engineer** by profession, with expertise in **RAG pipelines**, **NLP**, **LLM integrations**, and **cloud infrastructure**. Currently working at **[AMT](https://amt.in)** where I lead **MCP (Model Context Protocol)** client/server implementations, **RAG** and **NLP** pipelines and build production-grade AI systems. 
